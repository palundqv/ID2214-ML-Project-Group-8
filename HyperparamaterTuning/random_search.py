...
from evaluating_features import new_balance_labels_down
...
def test_hyperparameter_all_models_random_search(X, y, test_size=0.2, sampling="smote"):
...
if __name__ == "__main__":
    ...
    test_hyperparameter_all_models_random_search(
        training[list(n_best_features.keys())], training_lables
    )
